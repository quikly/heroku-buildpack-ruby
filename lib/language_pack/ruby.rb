...
512)
  ...
  export RUBY_GC_HEAP_GROWTH_MAX_SLOTS=${RUBY_GC_HEAP_GROWTH_MAX_SLOTS:-400000}
  export RUBY_GC_HEAP_GROWTH_FACTOR=${RUBY_GC_HEAP_GROWTH_FACTOR:-1.1}
  export RUBY_GC_MALLOC_LIMIT=${RUBY_GC_MALLOC_LIMIT:-16000000}
  export RUBY_GC_MALLOC_LIMIT_GROWTH_FACTOR=${RUBY_GC_MALLOC_LIMIT_GROWTH_FACTOR:-1.1}
  export RUBY_GC_MALLOC_LIMIT_MAX=${RUBY_GC_MALLOC_LIMIT_MAX:-16000000}
  export RUBY_GC_OLDMALLOC_LIMIT=${RUBY_GC_OLDMALLOC_LIMIT:-16000000}
  export RUBY_GC_OLDMALLOC_LIMIT_MAX=${RUBY_GC_OLDMALLOC_LIMIT_MAX:-16000000}
  ;;
16384)
...
32768)
  ...
  export WEB_CONCURRENCY=${WEB_CONCURRENCY:-15}
  ;;
*)
  ;;
esac
